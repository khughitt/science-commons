...
- Cell-cell communication analysis (MultiNicheNet): 64/100 top differential interactions were specific to the clonal (CHIP-positive) TME. Key predicted interactions: monocyte-to-T-cell proinflammatory (TNF-TNFRSF1B; IFN-γ/IFNGR1); immune checkpoint upregulation on effector T cells (HLA-DRB5/DRA-LAG3; CD48-CD244); clonal PCs signaling to naive T cells via TNFSF10-TNFRSF10D/C (TRAIL axis, potentially protecting MM PCs from apoptosis) and to NK cells via B2M-KLRC1 (inhibitory); TME-to-PC survival signals (TNFSF13B-TNFRSF17; CCL5-SDC1; IFNG-IFNGR1).
